...
#
# Changed to include stepper funtionality by Bojan Lazic
# 
#--------------------------------------
import smbus
import time
...
def main():
  ...
  while(1):
    ...
    print "IDLE : Temperature = ", temperature, "C"
    time.sleep(0.25)
    while temperature < 29:
    	print "MOVING BACKWARDS : Temperature = ", temperature, "C"
	temperature,pressure,humidity = readBME280All()  
	backwards(int(delay) / 1000.0, int(32))
    while temperature > 30:
	print "MOVING FORWARDS : Temperature = ", temperature, "C"
	temperature,pressure,humidity = readBME280All()
	forward(int(delay) / 1000.0, int(32))
